...
/*
|--------------------------------------------------------------------------
| Outerspace Grunt File
|--------------------------------------------------------------------------
|
| If you would like to edit the color of your Outerspace file just change
...
module.exports = function(grunt) {
	...
	var config = {
		...
		|--------------------------------------------------------------------------
		|
		| If you clone Outerspace into a separate folder, just change this variable
	...
	*/
	...
	grunt.initConfig({
		concat: {
			...
			dist: {
				src: ['src/*'],
				dest: 'Outerspace.json',
			},
		},
		'string-replace': {
			dist: {
				files: {
					'Outerspace.sublime-theme':['Outerspace.json'],
				'Outerspace/Widget - Outerspace.sublime-settings':['settings.json']
				},
				options: {
					replacements: [{
						pattern: /\{\{(.*?)\}\}/ig,
